...
IvPBox build1DBox(IvPDomain domain, string domstr, double vmin, double vmax) {
...
IvPBox build2DBox(IvPDomain domain, string domstr1, string domstr2, double val1,
                  double val2) {
  return (build2DBox(domain, domstr1, domstr2, val1, val1, val2, val2));
}

//-------------------------------------------------------------
// Procedure: build2DBox()

IvPBox build2DBox(IvPDomain domain, string domstr1, string domstr2,
