...
void Common_IPF_GUI::augmentMenu() {
  ...
  m_menubar->add("RotateZoom/Reset4 ", '=',
                 (Fl_Callback *)Common_IPF_GUI::cb_ModFrameBaseIPF, (void *)99,
                 0);
  ...
  m_menubar->add("IPF/Frame and FunctionBase -", '{',
                 (Fl_Callback *)Common_IPF_GUI::cb_ModFrameBaseIPF,
                 (void *)-10);
  m_menubar->add("IPF/Frame and FunctionBase +", '}',
  ...
  m_menubar->add("IPF/Toggle Pieces", 'p',
                 ...
                 FL_MENU_DIVIDER);
  m_menubar->add("IPF/Polar0", 0, (Fl_Callback *)Common_IPF_GUI::cb_Polar,
                 (void *)0, 0);
  m_menubar->add("IPF/Polar1", 0, (Fl_Callback *)Common_IPF_GUI::cb_Polar,
                 (void *)1, 0);
  m_menubar->add("IPF/Polar2", 0, (Fl_Callback *)Common_IPF_GUI::cb_Polar,
                 (void *)2, FL_MENU_DIVIDER);
...
//----------------------------------------- Quit
void Common_IPF_GUI::cb_Quit() { exit(0); }
