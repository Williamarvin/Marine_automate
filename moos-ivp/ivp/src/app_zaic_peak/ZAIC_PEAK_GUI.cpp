...
ZAIC_PEAK_GUI::ZAIC_PEAK_GUI(int wid, int hgt, const char *label)
  ...
  //==========================================================================
  m_fld_maxutil =
      new Fl_Output(620, q_height + top_marg + 10, 60, 20, "max_util:");
  m_fld_maxutil->textsize(txt_size);
  m_fld_maxutil->labelsize(txt_size);
  m_fld_maxutil->clear_visible_focus();

  m_fld_minutil =
      new Fl_Output(620, q_height + top_marg + 40, 60, 20, "min_util:");
...
void ZAIC_PEAK_GUI::augmentMenu() {
  ...
  mbar->add("Modify Mode/ZAIC 1: Adjust SummitDelta ", '3',
            (Fl_Callback *)ZAIC_PEAK_GUI::cb_CurrMode, (void *)3,
            FL_MENU_DIVIDER);
  ...
  mbar->add("Modify Mode/ZAIC 2: Adjust SummitDelta ", '7',
            (Fl_Callback *)ZAIC_PEAK_GUI::cb_CurrMode, (void *)7,
            FL_MENU_DIVIDER);
...
void ZAIC_PEAK_GUI::updateOutput() {
  ...
  str =
      doubleToString(((ZAIC_PEAK_Model *)(m_zaic_model))->getSummitDelta1(), 2);
  ...
  str =
      doubleToString(((ZAIC_PEAK_Model *)(m_zaic_model))->getSummitDelta2(), 2);
