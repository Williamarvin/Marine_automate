...
ZAIC_SPD_GUI::ZAIC_SPD_GUI(int g_w, int g_h, const char *g_l)
  ...
  m_zaic_viewer =
      new ZAIC_Viewer(sid_marg, top_marg, w() - (sid_marg * 2), q_height);
  ...
  m_lowval_util =
      new Fl_Output(450, q_height + top_marg + 10, 60, 20, "lowval_util:");
  m_lowval_util->textsize(info_size);
  m_lowval_util->labelsize(info_size);
  m_lowval_util->clear_visible_focus();

  m_hghval_util =
      new Fl_Output(600, q_height + top_marg + 10, 60, 20, "hghval_util:");
...
Fl_Menu_Item ZAIC_SPD_GUI::menu_[] = {
    ...
    {"Grid Size Reset ", 'g', (Fl_Callback *)ZAIC_SPD_GUI::cb_GridSize,
     (void *)0, 0},
    {"Grid Size Smaller ", FL_ALT + 'g',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_GridSize, (void *)-1, 0},
    {"Grid Size Larger ", FL_CTRL + 'g',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_GridSize, (void *)1, FL_MENU_DIVIDER},
    {"Grid Shade Reset ", 's', (Fl_Callback *)ZAIC_SPD_GUI::cb_GridShade,
     (void *)0, 0},
    {"Grid Shade Lighter ", FL_ALT + 's',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_GridShade, (void *)-1, 0},
    {"Grid Shade Darker ", FL_CTRL + 's',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_GridShade, (void *)1, FL_MENU_DIVIDER},
    {"Back Shade Reset ", 'b', (Fl_Callback *)ZAIC_SPD_GUI::cb_BackShade,
     (void *)0, 0},
    {"Back Shade Lighter ", FL_ALT + 'b',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_BackShade, (void *)-1, 0},
    {"Back Shade Darker ", FL_CTRL + 'b',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_BackShade, (void *)1, FL_MENU_DIVIDER},
    {"Line Shade Reset ", 'l', (Fl_Callback *)ZAIC_SPD_GUI::cb_LineShade,
     (void *)0, 0},
    {"Line Shade Lighter ", FL_ALT + 'l',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_LineShade, (void *)-1, 0},
    {"Line Shade Darker ", FL_CTRL + 'l',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_LineShade, (void *)1, FL_MENU_DIVIDER},
    {"Toggle Verbose ", 'v', (Fl_Callback *)ZAIC_SPD_GUI::cb_ToggleVerbose,
     (void *)1, FL_MENU_DIVIDER},
    {"Toggle Labels ", 'j', (Fl_Callback *)ZAIC_SPD_GUI::cb_ToggleLabels,
     (void *)1, FL_MENU_DIVIDER},
    {"Toggle ColorScheme ", 'c',
     (Fl_Callback *)ZAIC_SPD_GUI::cb_ToggleColorScheme, (void *)1,
     FL_MENU_DIVIDER},
    {0},

    {"Modify Mode", 0, 0, 0, 64, 0, 0, 14, 0},
    {"Adjust MedVal ", '0', (Fl_Callback *)ZAIC_SPD_GUI::cb_CurrMode, (void *)0,
     FL_MENU_RADIO | FL_MENU_VALUE},
    {"Adjust LowVal ", '1', (Fl_Callback *)ZAIC_SPD_GUI::cb_CurrMode, (void *)1,
     FL_MENU_RADIO},
    {"Adjust HighVal ", '2', (Fl_Callback *)ZAIC_SPD_GUI::cb_CurrMode,
     (void *)2, FL_MENU_RADIO},
    {"Adjust LowValUtil ", '3', (Fl_Callback *)ZAIC_SPD_GUI::cb_CurrMode,
     (void *)3, FL_MENU_RADIO},
    {"Adjust HighValUtil ", '4', (Fl_Callback *)ZAIC_SPD_GUI::cb_CurrMode,
     (void *)4, FL_MENU_RADIO},
    {0},

    {"Modify ZAIC", 0, 0, 0, 64, 0, 0, 14, 0},
    {"Move Left  ", FL_Left, (Fl_Callback *)ZAIC_SPD_GUI::cb_MoveX, (void *)-1,
     0},
    {"Move Right ", FL_Right, (Fl_Callback *)ZAIC_SPD_GUI::cb_MoveX, (void *)1,
     0},
    {0},
...
//----------------------------------------- Quit
void ZAIC_SPD_GUI::cb_Quit() { exit(0); }
