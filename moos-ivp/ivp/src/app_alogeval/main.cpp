...
int main(int argc, char *argv[]) {
  ...
  for (int i = 1; i < argc; i++) {
    ...
    if ((argi == "-h") || (argi == "--help") || (argi == "-help")) {
      cout << "Usage: " << endl;
      cout << "  alogeval in.alog criteria.txt [OPTIONS]                "
           << endl;
      cout << "                                                         "
           << endl;
      cout << "Synopsis:                                                "
           << endl;
      cout << "  Scan the given alog file and apply the test criteria   "
           << endl;
      cout << "  found in criteria.txt. The criteria should be in the   "
           << endl;
      cout << "  same format as would be provided in pMissionEval.      "
           << endl;
      cout << "                                                         "
           << endl;
      ...
      cout << "  in.alog       - The input logfile.                     "
           << endl;
      cout << "  criteria.txt  - The test criteria file                 "
           << endl;
      cout << "                                                         "
           << endl;
      cout << "Options:                                                 "
      ...
      cout << "  --verbose         Verbose mode                         "
           << endl;
      cout << "  --show_seq, -ss   Show Logic test structure at start,  "
           << endl;
      cout << "                    and at finish. --verbose also needed "
           << endl;
      cout << "                                                         "
           << endl;
      cout << "  --web,-w   Open browser to:                            "
           << endl;
      cout << "             https://oceanai.mit.edu/ivpman/apps/alogeval"
           << endl;
      cout << "                                                         "
           << endl;
      cout << "Returns:                                                 "
           << endl;
      cout << "  0 if all input ok, and passes test logic               "
           << endl;
      cout << "  1 All valid files, but one or more test criteria failed"
           << endl;
      cout << "  2 if unhandled command line argument.                  "
           << endl;
      cout << "  3 if unreadable or missing alog file input             "
           << endl;
      cout << "  4 if unreadable or missing test criteria input file    "
           << endl;
      cout << "  5 if invalid contents of alog or criteria input file   "
           << endl;
      cout << "                                                         "
           << endl;
      cout << "Examples:                                                "
           << endl;
      cout << "$ alogeval in.alog criteria.txt                          "
           << endl;
      cout << "$ alogeval in.alog --testfile=criteria.txt               "
           << endl;
      cout << "$ alogeval in.alog criteria.txt --verbose -ss            "
           << endl;
      cout << endl;
      return (0);
