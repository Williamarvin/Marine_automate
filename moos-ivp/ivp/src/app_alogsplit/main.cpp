...
int main(int argc, char *argv[]) {
  ...
  if (scanArgs(argc, argv, "-h", "--help", "-help")) {
    cout << "Usage: " << endl;
    cout << "  alogsplit in.alog [OPTIONS]                              "
         << endl;
    cout << "                                                           "
         << endl;
    cout << "Synopsis:                                                  "
         << endl;
    cout << "  Split the given alog file into a directory, within which "
         << endl;
    cout << "  each MOOS variable is split into its own (klog) file     "
         << endl;
    cout << "  containing only that variable. The split will also create"
         << endl;
    cout << "  a summary.klog file with summary information.            "
         << endl;
    cout << "                                                           "
         << endl;
    cout << "  Given file.alog, file_alvtmp/ directory will be created. "
         << endl;
    cout << "  Will not overwrite directory if previously created.      "
         << endl;
    cout << "  This is essentially the operation done at the outset of  "
         << endl;
    cout << "  launching the alogview applicaton.                       "
         << endl;
    cout << "                                                           "
         << endl;
    ...
    cout << "  -v,--version   Displays the current release version      "
         << endl;
    cout << "  --verbose      Show output for successful operation      "
         << endl;
    cout << "  --dir=DIR      Override the default dir with given dir.  "
         << endl;
    cout << "                                                           "
         << endl;
    cout << "  --max_fptrs=N  Set max number of OS file pointers allowed"
         << endl;
    cout << "                 to be open during splitting. Default 125. "
         << endl;
    cout << "                                                           "
         << endl;
    ...
    cout << "Further Notes:                                             "
         << endl;
    cout << "  (1) The order of arguments is irrelevant.                "
         << endl;
    cout << "  (2) See also: alogscan, alogrm, aloggrep, alogclip,      "
         << endl;
    cout << "      alogview " << endl;
    cout << endl;
    return (0);
