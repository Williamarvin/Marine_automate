...
protected:
  ...
  void postOffboardMessage(std::string dest, std::string var, std::string sval,
                           std::string key = "");
  void postOffboardMessage(std::string dest, std::string var, double dval,
                           std::string key = "");
  void postOffboardMessage(std::string dest, std::string var, bool bval,
                           std::string key = "");
