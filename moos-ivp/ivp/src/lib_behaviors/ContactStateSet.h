...
public:
  ...
  void set_os_crosses_cn_stern(bool v) {
    m_cnos_curr.set_os_crosses_cn_stern(v);
  }
  void set_os_crosses_cn_bow(bool v) { m_cnos_curr.set_os_crosses_cn_bow(v); }
  void set_os_crosses_cn_bow_dist(double v) {
    m_cnos_curr.set_os_crosses_cn_bow_dist(v);
  }
  ...
  void set_cn_crosses_os_stern(bool v) {
    m_cnos_curr.set_cn_crosses_os_stern(v);
  }
  void set_cn_crosses_os_bow_dist(double v) {
    m_cnos_curr.set_cn_crosses_os_bow_dist(v);
  }
