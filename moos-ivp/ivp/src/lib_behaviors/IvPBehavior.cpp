...
bool IvPBehavior::setParam(string g_param, string g_val) {
  ...
  if (g_param == "us") {
    m_us_name = g_val;
    return (true);
  } else if ((g_param == "pwt") || (g_param == "priwt") ||
...
void IvPBehavior::postMessage(string var, string sval, double dval,
                              string key) {
  if (sval != "")
...
void IvPBehavior::postXMessage(string var, string sdata, double ddata,
                               string key) {
  if (sdata != "")
...
void IvPBehavior::postGMessage(string var, string sdata, double ddata,
                               string key) {
  if (sdata != "")
...
void IvPBehavior::postOffboardMessage(string dest, string var, double ddata,
                                      string key) {
...
void IvPBehavior::postOffboardMessage(string dest, string var, string sdata,
                                      string key) {
  VarDataPair pair(var, sdata);
  postOffboardMessage(dest, pair, key);
}
...
void IvPBehavior::postOffboardMessage(string dest, string var, bool bdata,
                                      string key) {
...
bool IvPBehavior::addFlagOnString(vector<VarDataPair> &pairs, string str) {
