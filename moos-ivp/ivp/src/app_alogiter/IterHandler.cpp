...
IterHandler::IterHandler() { m_file_in = 0; }
...
void IterHandler::printReportGap() {
  ...
  for (p = m_map_app_gap_count.begin(); p != m_map_app_gap_count.end(); p++) {
    ...
    double gap_pct_1p25 =
        (double)(m_map_app_gap_count_1p25[app_name]) / gap_cnt;
    double gap_pct_1p50 =
        (double)(m_map_app_gap_count_1p50[app_name]) / gap_cnt;
    double gap_pct_2p00 =
        (double)(m_map_app_gap_count_2p00[app_name]) / gap_cnt;
...
void IterHandler::printReportLen() {
  ...
  for (p = m_map_app_gap_count.begin(); p != m_map_app_gap_count.end(); p++) {
    ...
    double len_pct_0p25 =
        (double)(m_map_app_len_count_0p25[app_name]) / len_cnt;
    double len_pct_0p50 =
        (double)(m_map_app_len_count_0p50[app_name]) / len_cnt;
    double len_pct_0p75 =
        (double)(m_map_app_len_count_0p75[app_name]) / len_cnt;
    double len_pct_1p00 =
        (double)(m_map_app_len_count_1p00[app_name]) / len_cnt;
