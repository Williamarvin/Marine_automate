...
//-------------------------------------------------------------------
bool ScalarPID::Run(double dfeIn, double dfErrorTime, bool reset_I,
                    double &dfOut) {
  ...
  // dfeIn=145.88560, dfErrorTime=1556750915.09088, m_dfDT=0.10035,
  // dfDiffNow=0.09397, DiffHistSize=9, mdfeDiff(1)=0.92005,
  // mdfeDiff(2)=0.10223, m_dfOut(1)218.84885, m_dfOut(1)100
...
bool ScalarPID::Log() {
  ...
  if (m_bLog) {
    if (!m_LogFile.is_open()) {
      string sName =
          MOOSFormat("%s%s%s.pid", m_sLogPath.c_str(), m_sName.c_str(),
...
//-------------------------------------------------------------------
void ScalarPID::SetName(string sName) { m_sName = sName; }

//-------------------------------------------------------------------
void ScalarPID::SetLog(bool bLog) { m_bLog = bLog; }
...
//-------------------------------------------------------------------
void ScalarPID::SetGoal(double dfGoal) { m_dfGoal = dfGoal; }
