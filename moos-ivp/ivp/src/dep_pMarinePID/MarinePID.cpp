...
bool MarinePID::handleYawSettings() {
  ...
  if (m_reset_hdg_i_zero_error || m_reset_hdg_i_new_desired)
    m_pengine.setHdgIntegralReset(m_reset_hdg_i_zero_error,
...
bool MarinePID::handleSpeedSettings() {
  ...
  if (m_reset_spd_i_zero_error || m_reset_spd_i_new_desired)
    m_pengine.setSpdIntegralReset(m_reset_spd_i_zero_error,
...
bool MarinePID::handleDepthSettings() {
  ...
  m_depth_control =
      ((depth_control_str == "true") || (depth_control_str == "1") ||
  ...
  if (m_reset_dep_i_zero_error || m_reset_dep_i_new_desired)
    m_pengine.setDepIntegralReset(m_reset_dep_i_zero_error,
                                  m_reset_dep_i_new_desired);
  ...
  if (m_reset_pch_i_zero_error || m_reset_pch_i_new_desired)
    m_pengine.setPchIntegralReset(m_reset_pch_i_zero_error,
                                  m_reset_pch_i_new_desired);
...
bool MarinePID::buildReport() {
  ...
  m_msgs << "  time_last_helm_msg: "
         << doubleToString(m_time_of_last_helm_msg, 2) << endl;
  m_msgs << "  time_last_nav_msg:  "
         << doubleToString(m_time_of_last_nav_msg, 2) << endl;
  m_msgs << "                  " << endl;
  ...
  m_msgs << "                     " << endl;
  m_msgs << "  tardy_helm_thresh: " << doubleToString(m_tardy_helm_thresh)
         << endl;
  m_msgs << "  tardy_nav_thresh:  " << doubleToString(m_tardy_nav_thresh)
         << endl;
