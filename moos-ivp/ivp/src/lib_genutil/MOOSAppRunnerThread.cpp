...
MOOSAppRunnerThread::MOOSAppRunnerThread(CMOOSApp *app, const char *name,
                                         const char *mission_file, int argc,
                                         char **argv)
...
MOOSAppRunnerThread::~MOOSAppRunnerThread() { delete m_thread; }
