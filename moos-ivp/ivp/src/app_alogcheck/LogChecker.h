...
public:
  ...
  virtual bool addStartFlag(std::string str) {
    return (addFlag(str, m_start_flags));
  }
  virtual bool addEndFlag(std::string str) {
    return (addFlag(str, m_end_flags));
  }
  virtual bool addFailFlag(std::string str) {
    return (addFlag(str, m_fail_flags));
  }
  virtual bool addPassFlag(std::string str) {
    return (addFlag(str, m_pass_flags));
  }
