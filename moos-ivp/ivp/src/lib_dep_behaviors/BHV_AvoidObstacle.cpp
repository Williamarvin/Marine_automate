...
BHV_AvoidObstacle::BHV_AvoidObstacle(IvPDomain gdomain) : IvPBehavior(gdomain) {
...
void BHV_AvoidObstacle::onSetParamComplete() { postConfigStatus(); }
...
void BHV_AvoidObstacle::onIdleState() { postErasablePolygons(); }
...
void BHV_AvoidObstacle::onInactiveState() { postErasablePolygons(); }

//-----------------------------------------------------------
// Procedure: onIdleToRunState

void BHV_AvoidObstacle::onIdleToRunState() { postConfigStatus(); }

//-----------------------------------------------------------
// Procedure: onSpawn()

void BHV_AvoidObstacle::onSpawn() { postMessage("AVD_OB_SPAWN", m_descriptor); }
