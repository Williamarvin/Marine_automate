...
BHV_HAttractor::BHV_HAttractor(IvPDomain gdomain) : IvPBehavior(gdomain) {
...
double BHV_HAttractor::getRelevance(double osX, double osY, double cnX,
                                    double cnY) {
...
//   Purpose: Maintain a list of known unique contact names, and subscrinbe to
//   NAV info
