...
void BHV_AvoidObstacleX::onSetParamComplete() { postConfigStatus(); }
...
void BHV_AvoidObstacleX::onCompleteState() { postErasablePolygons(); }

//-----------------------------------------------------------
// Procedure: onInactiveState()

void BHV_AvoidObstacleX::onInactiveState() { postErasablePolygons(); }

//-----------------------------------------------------------
// Procedure: onIdleToRunState()

void BHV_AvoidObstacleX::onIdleToRunState() { postConfigStatus(); }
