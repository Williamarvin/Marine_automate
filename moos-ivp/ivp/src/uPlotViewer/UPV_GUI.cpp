...
UPV_GUI::UPV_GUI(int g_w, int g_h, const char *g_l) : Fl_Window(g_w, g_h, g_l) {
  ...
  m_plot_viewer =
      new UPV_Viewer(sid_marg, top_marg, w() - (sid_marg * 2), q_height);
...
Fl_Menu_Item UPV_GUI::menu_[] = {
    ...
    {"Grid Size Reset ", 'g', (Fl_Callback *)UPV_GUI::cb_GridSize, (void *)0,
     0},
    {"Grid Size Smaller ", FL_ALT + 'g', (Fl_Callback *)UPV_GUI::cb_GridSize,
     (void *)-1, 0},
    {"Grid Size Larger ", FL_CTRL + 'g', (Fl_Callback *)UPV_GUI::cb_GridSize,
     (void *)1, FL_MENU_DIVIDER},
    {"Grid Shade Reset ", 's', (Fl_Callback *)UPV_GUI::cb_GridShade, (void *)0,
     0},
    {"Grid Shade Lighter ", FL_ALT + 's', (Fl_Callback *)UPV_GUI::cb_GridShade,
     (void *)-1, 0},
    {"Grid Shade Darker ", FL_CTRL + 's', (Fl_Callback *)UPV_GUI::cb_GridShade,
     (void *)1, FL_MENU_DIVIDER},
    {"Back Shade Reset ", 'b', (Fl_Callback *)UPV_GUI::cb_BackShade, (void *)0,
     0},
    {"Back Shade Lighter ", FL_ALT + 'b', (Fl_Callback *)UPV_GUI::cb_BackShade,
     (void *)-1, 0},
    {"Back Shade Darker ", FL_CTRL + 'b', (Fl_Callback *)UPV_GUI::cb_BackShade,
     (void *)1, FL_MENU_DIVIDER},
    {"Line Shade Reset ", 'l', (Fl_Callback *)UPV_GUI::cb_LineShade, (void *)0,
     0},
    {"Line Shade Lighter ", FL_ALT + 'l', (Fl_Callback *)UPV_GUI::cb_LineShade,
     (void *)-1, 0},
    {"Line Shade Darker ", FL_CTRL + 'l', (Fl_Callback *)UPV_GUI::cb_LineShade,
     (void *)1, FL_MENU_DIVIDER},
    {0},
...
void UPV_GUI::addScopeVar(string varname) {
  ...
  m_menubar->add(entry.c_str(), 0, (Fl_Callback *)UPV_GUI::cb_ChangeScopeVar,
  ...
  m_menubar->add(entry2.c_str(), 0, (Fl_Callback *)UPV_GUI::cb_ToggleScopeVar,
                 (void *)index, FL_MENU_TOGGLE);
