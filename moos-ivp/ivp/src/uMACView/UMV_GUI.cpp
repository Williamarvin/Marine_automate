...
UMV_GUI::UMV_GUI(int g_w, int g_h, const char *g_l) : Fl_Window(g_w, g_h, g_l) {
  ...
  m_rc_button_utc->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)24);
  m_rc_button_src->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)25);
  m_rc_button_com->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)26);
  m_rc_button_wrp->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)27);

  m_rc_button_sub->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)28);
  m_rc_button_msk->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)29);
  m_rc_button_trc->callback((Fl_Callback *)UMV_GUI::cb_REALM_Button,
                            (void *)30);
...
void UMV_GUI::augmentMenu() {
  m_menubar->add("File/Quit ", FL_CTRL + 'q', (Fl_Callback *)UMV_GUI::cb_Quit,
                 0, 0);
  ...
  m_menubar->add(
      ...
      (Fl_Callback *)UMV_GUI::cb_InfoCastSetting, (void *)309, FL_MENU_DIVIDER);

  m_menubar->add("InfoCasting/InfoCast Window Height/taller", FL_SHIFT + FL_Up,
                 (Fl_Callback *)UMV_GUI::cb_InfoCastSetting, (void *)200, 0);
  m_menubar->add("InfoCasting/InfoCast Window Height/shorter",
                 FL_SHIFT + FL_Down, (Fl_Callback *)UMV_GUI::cb_InfoCastSetting,
                 (void *)201, 0);
  ...
  m_menubar->add(
      "InfoCasting/realmcast_time_format/realmcast_time_format_utc=true", 0,
      (Fl_Callback *)UMV_GUI::cb_InfoCastSetting, (void *)380, FL_MENU_RADIO);
  m_menubar->add(
      "InfoCasting/realmcast_time_format/realmcast_time_format_utc=false", 0,
      (Fl_Callback *)UMV_GUI::cb_InfoCastSetting, (void *)381, FL_MENU_RADIO);
  m_menubar->add(
      "InfoCasting/realmcast_time_format/realmcast_time_format_utc Toggle", 0,
...
inline void UMV_GUI::cb_InfoCastSetting_i(unsigned int v) {
  ...
  // Handle InfoCast pane height explicit setting
    ...
    setRadioCastAttrib("appcast_color_scheme", "default");
  else if (v == 301)
