...
void GUI_VarScope::initWidgets() {
  ...
  m_but_vname->callback((Fl_Callback *)GUI_VarScope::cb_ButtonFilter,
                        (void *)0);
  ...
  m_but_varname->callback((Fl_Callback *)GUI_VarScope::cb_ButtonFilter,
                          (void *)1);
  ...
  m_but_source->callback((Fl_Callback *)GUI_VarScope::cb_ButtonFilter,
                         (void *)2);
  ...
  m_but_srcaux->callback((Fl_Callback *)GUI_VarScope::cb_ButtonFilter,
                         (void *)3);
  ...
  m_but_addvar->callback((Fl_Callback *)GUI_VarScope::cb_ButtonAddVar,
                         (void *)-1);

  m_but_setvar = new Fl_Menu_Button(0, 0, 1, 1, "Set Variable");
  m_but_setvar->clear_visible_focus();
  m_but_setvar->callback((Fl_Callback *)GUI_VarScope::cb_ButtonSetVar,
                         (void *)-1);

  m_but_delvar = new Fl_Menu_Button(0, 0, 1, 1, "Del Variable");
  m_but_delvar->clear_visible_focus();
  m_but_delvar->callback((Fl_Callback *)GUI_VarScope::cb_ButtonDelVar,
                         (void *)-1);
...
Fl_Menu_Item GUI_VarScope::menu_[] = {
    ...
    {"Replay/Step+1", FL_CTRL + ']', (Fl_Callback *)GUI_VarScope::cb_Step,
     (void *)100, 0},
    {"Replay/Step-", FL_CTRL + '[', (Fl_Callback *)GUI_VarScope::cb_Step,
     (void *)-100, 0},
    {"Replay/Step+1", ']', (Fl_Callback *)GUI_VarScope::cb_Step, (void *)1000,
     0},
    {"Replay/Step-", '[', (Fl_Callback *)GUI_VarScope::cb_Step, (void *)-1000,
     0},
    {"Replay/Step+5", '}', (Fl_Callback *)GUI_VarScope::cb_Step, (void *)5000,
     0},
    {"Replay/Step-5", '{', (Fl_Callback *)GUI_VarScope::cb_Step, (void *)-5000,
     0},
    {0}};
