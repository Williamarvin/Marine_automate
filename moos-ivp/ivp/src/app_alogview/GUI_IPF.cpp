...
void GUI_IPF::initWidgets() {
  ...
  m_but_collective->callback((Fl_Callback *)GUI_IPF::cb_SelectCollective,
                             (void *)0);

  m_but_collective_dep = new Fl_Check_Button(0, 0, 1, 1, "CollectiveD");
  m_but_collective_dep->clear_visible_focus();
  m_but_collective_dep->callback((Fl_Callback *)GUI_IPF::cb_SelectCollective,
                                 (void *)1);

  m_but_show_pcs = new Fl_Check_Button(0, 0, 1, 1, "pcs");
  m_but_show_pcs->clear_visible_focus();
  m_but_show_pcs->callback((Fl_Callback *)Common_IPF_GUI::cb_ToggleDrawPcs,
                           (void *)1);
  ...
  m_but_addvar_a->callback((Fl_Callback *)GUI_IPF::cb_ButtonAddVarA,
                           (void *)-1);

  m_but_addvar_b = new Fl_Menu_Button(0, 0, 1, 1, "Scope Var B");
  m_but_addvar_b->clear_visible_focus();
  m_but_addvar_b->callback((Fl_Callback *)GUI_IPF::cb_ButtonAddVarB,
                           (void *)-1);
}
      ...
      if (!strBegins(varname, "BHV_IPF")) {
        ...
        if (!strContains(source, "pHelmIvP")) {
          ...
          m_but_addvar_a->add(entry.c_str(), 0,
                              (Fl_Callback *)GUI_IPF::cb_ButtonAddVarA,
                              (void *)iix);
          m_but_addvar_b->add(entry.c_str(), 0,
                              (Fl_Callback *)GUI_IPF::cb_ButtonAddVarB,
                              (void *)iix);
        }
      }
    }
