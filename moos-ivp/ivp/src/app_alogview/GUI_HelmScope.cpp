...
void GUI_HelmScope::initWidgets() {
  ...
  m_but_gen_levents->callback(
      (Fl_Callback *)GUI_HelmScope::cb_ButtonLifeEvents);
...
Fl_Menu_Item GUI_HelmScope::menu_[] = {
    ...
    {"Replay/Step+1", FL_CTRL + ']', (Fl_Callback *)GUI_HelmScope::cb_Step,
     (void *)100, 0},
    {"Replay/Step-", FL_CTRL + '[', (Fl_Callback *)GUI_HelmScope::cb_Step,
     (void *)-100, 0},
    {"Replay/Step+1", ']', (Fl_Callback *)GUI_HelmScope::cb_Step, (void *)1000,
     0},
    {"Replay/Step-", '[', (Fl_Callback *)GUI_HelmScope::cb_Step, (void *)-1000,
     0},
    {"Replay/Step+5", '}', (Fl_Callback *)GUI_HelmScope::cb_Step, (void *)5000,
     0},
    {"Replay/Step-5", '{', (Fl_Callback *)GUI_HelmScope::cb_Step, (void *)-5000,
     0},
