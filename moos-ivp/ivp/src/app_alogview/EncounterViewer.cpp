...
void EncounterViewer::draw() {
  ...
  // cout << "In EncounterViewer::draw()  " << "w:" << w() << ", h:" << h() <<
  // endl; cout << "vname: " << m_vname << endl; cout << "plotsize: " <<
  // m_encounter_plot.size() << endl;
  ...
  // Prepare to draw
  glClearColor(m_clear_color.red(), m_clear_color.grn(), m_clear_color.blu(),
               0.0);
...
void EncounterViewer::handleLeftMouse(int vx, int vy) {
  // cout << "EncounterViewer::handleLeftMouse: x:" << vx << ", y:" << vx <<
  // endl;
...
void EncounterViewer::handleRightMouse(int vx, int vy) {
  // cout << "EncounterViewer::handleRightMouse: x:" << vx << ", y:" << vx <<
  // endl;
}
...
void EncounterViewer::setOwningGUI(GUI_Encounters *gui) { m_owning_gui = gui; }
...
void EncounterViewer::setTime(double time) { m_curr_time = time; }
...
double EncounterViewer::getCurrTime() const { return (m_curr_time); }
