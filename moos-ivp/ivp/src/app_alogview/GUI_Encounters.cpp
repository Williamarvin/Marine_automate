...
void GUI_Encounters::initWidgets() {
  ...
  m_but_curr_go->callback((Fl_Callback *)GUI_Encounters::cb_SelectGo,
                          (void *)0);
}
...
Fl_Menu_Item GUI_Encounters::menu_[] = {
    ...
    {"Replay/Step +0.1 secs", FL_CTRL + ']',
     (Fl_Callback *)GUI_Encounters::cb_Step, (void *)100, 0},
    {"Replay/Step -0.1 secs", FL_CTRL + '[',
     (Fl_Callback *)GUI_Encounters::cb_Step, (void *)-100, 0},
    {"Replay/Step +1 sec", ']', (Fl_Callback *)GUI_Encounters::cb_Step,
     (void *)1000, 0},
    {"Replay/Step -1 sec", '[', (Fl_Callback *)GUI_Encounters::cb_Step,
     (void *)-1000, 0},
    {"Replay/Step +5 secs", '}', (Fl_Callback *)GUI_Encounters::cb_Step,
     (void *)5000, 0},
    {"Replay/Step -5 secs", '{', (Fl_Callback *)GUI_Encounters::cb_Step,
     (void *)-5000, 0},
    {0}};
