...
void GUI_AppLogScope::initWidgets() {
  ...
  m_but_separate->callback((Fl_Callback *)GUI_AppLogScope::cb_ButtonSeparate,
                           (void *)0);
  ...
  m_but_truncate->callback((Fl_Callback *)GUI_AppLogScope::cb_ButtonTruncate,
                           (void *)0);
  ...
  m_but_wrapline->callback((Fl_Callback *)GUI_AppLogScope::cb_ButtonWrapLine,
                           (void *)0);
  ...
  m_but_future->callback((Fl_Callback *)GUI_AppLogScope::cb_ButtonFuture,
                         (void *)0);
  ...
  m_but_mod_grep1->callback((Fl_Callback *)GUI_AppLogScope::cb_ModGrep,
                            (void *)1);

  m_but_apply_grep1 = new Fl_Check_Button(0, 0, 0, 0, "ApplyGrep1");
  m_but_apply_grep1->labelcolor(bcolor);
  m_but_apply_grep1->callback(
      (Fl_Callback *)GUI_AppLogScope::cb_ButtonApplyGrep, (void *)1);
  ...
  m_but_text_more->callback((Fl_Callback *)GUI_AppLogScope::cb_ModText,
                            (void *)1);
  ...
  m_but_apply_grep2->callback(
      (Fl_Callback *)GUI_AppLogScope::cb_ButtonApplyGrep, (void *)2);
  ...
  m_but_mod_grep2->callback((Fl_Callback *)GUI_AppLogScope::cb_ModGrep,
                            (void *)2);

  m_but_text_less = new Fl_Button(0, 0, 0, 0, "Text");
  m_but_text_less->clear_visible_focus();
  m_but_text_less->callback((Fl_Callback *)GUI_AppLogScope::cb_ModText,
                            (void *)2);
...
Fl_Menu_Item GUI_AppLogScope::menu_[] = {
    ...
    {"Replay/Step+1", FL_CTRL + ']', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)100, 0},
    {"Replay/Step-", FL_CTRL + '[', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)-100, 0},
    {"Replay/Step+1", ']', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)1000, 0},
    {"Replay/Step-", '[', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)-1000, 0},
    {"Replay/Step+5", '}', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)5000, 0},
    {"Replay/Step-5", '{', (Fl_Callback *)GUI_AppLogScope::cb_Step,
     (void *)-5000, 0},
    {0}};
