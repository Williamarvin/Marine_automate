...
int main(int argc, char *argv[]) {
  ...
  if (scanArgs(argc, argv, "-h", "--help", "-help")) {
    ...
    cout << "Synopsis:                                                  "
         << endl;
    cout << "  Perform one of several optional helm reports based on    "
         << endl;
    cout << "  helm output logged in the given .alog file.              "
         << endl;
    cout << "                                                           "
         << endl;
    cout << "Options:                                                   "
    ...
    cout << "  -v,--version  Displays the current release version       "
         << endl;
    cout << "  -l,--life     Show report on IvP Helm Life Events        "
         << endl;
    cout << "  -b,--bhvs     Show helm behavior state changes           "
         << endl;
    cout << "  -m,--modes    Show helm mode changes                     "
         << endl;
    cout << "  --watch=bhv   Watch a particular behavior for state change"
         << endl;
    cout << "  --nocolor     Turn off use of color coding               "
         << endl;
    cout << "  --notrunc     Don't truncate MOOSVAR output (on by default)"
         << endl;
    cout << "                                                           "
         << endl;
    cout << "  --web,-w   Open browser to:                              "
         << endl;
    cout << "             https://oceanai.mit.edu/ivpman/apps/aloghelm  "
         << endl;
    cout << "Further Notes:                                             "
         << endl;
    cout << "  (1) The order of arguments is irrelevant.                "
         << endl;
    cout << "  (2) Only the first specified .alog file is reported on.  "
         << endl;
    cout << "  (3) Arguments that are not one of the above options or an"
         << endl;
    cout << "      alog file, are interpreted as MOOS variables on which"
         << endl;
    cout << "      to report as encountered.                            "
         << endl;
    cout << endl;
    return (0);
  }
