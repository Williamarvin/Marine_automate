...
std::vector<std::string> parseString(const std::string &, const std::string &);
...
bool listContains(const std::list<std::string> &, const std::string &,
                  bool case_sensitive = true);
...
bool tokParse(const std::string &, const std::string &, char, char,
              std::string &);
bool tokParse(const std::string &, const std::string &, char, char, double &);
bool tokParse(const std::string &, const std::string &, char, char, bool &);

std::string tokStringParse(const std::string &, const std::string &,
                           char gsep = ',', char lsep = '=');
double tokDoubleParse(const std::string &, const std::string &, char gsep = ',',
                      char lsep = '=');
...
bool setMinPartOfPairOnString(double &minval, double &maxval, std::string str,
                              bool negok = false);
bool setMaxPartOfPairOnString(double &minval, double &maxval, std::string str,
                              bool negok = false);
bool setDoubleRngOnString(double &dval, std::string str, double minv,
                          double maxv);
bool setDoubleClipRngOnString(double &dval, std::string str, double minv,
                              double maxv);
bool setDoubleStrictRngOnString(double &dval, std::string str, double minv,
                                double maxv);
...
std::vector<std::string> breakLen(const std::vector<std::string> &,
                                  unsigned int maxlen);
std::vector<std::string> breakLen(const std::string &, unsigned int maxlen);
