...
vector<double> colorHexToVector(const string &str) {
  ...
  if ((svector[0].length() != 2) || (svector[1].length() != 2) ||
      (svector[2].length() != 2))
    return (return_vector);
...
bool isColor(const string &str) {
  if ((tolower(str) == "black") || (tolower(str) == "empty") ||
      (tolower(str) == "off") || (tolower(str) == "invisible"))
    return (true);
...
string colorNameToHex(const string &str) {
  ...
  if (cstr == "darksalmon")
    return ("hex:e9,96,7a");
  if (cstr == "darkseagreen")
    return ("hex:8f,bc,8f");
  if (cstr == "darkslateblue")
    return ("hex:48,3d,8b");
  if (cstr == "darkslategray")
    return ("hex:2f,4f,4f");
  if (cstr == "darkturquoise")
    return ("hex:00,ce,d1");
  if (cstr == "darkviolet")
    return ("hex:94,00,d3");
  if (cstr == "deeppink")
  ...
  if (cstr == "lavender")
    return ("hex:e6,e6,fa");
  if (cstr == "lavenderblush")
    return ("hex:ff,f0,f5");
  if (cstr == "lawngreen")
    return ("hex:7c,fc,00");
  if (cstr == "lemonchiffon")
    return ("hex:ff,fa,cd");
  if (cstr == "lightblue")
    return ("hex:ad,d8,e6");
  if (cstr == "lightcoral")
  ...
  if (cstr == "lightsalmon")
    return ("hex:ff,a0,7a");
  if (cstr == "lightseagreen")
    return ("hex:20,b2,aa");
  if (cstr == "lightskyblue")
    return ("hex:87,ce,fa");
  if (cstr == "lightslategray")
    return ("hex:77,88,99");
  if (cstr == "lightsteelblue")
    return ("hex:b0,c4,de");
  if (cstr == "lightyellow")
    return ("hex:ff,ff,e0");
  if (cstr == "lime")
  ...
  if (cstr == "mediumblue")
    return ("hex:00,00,cd");
  if (cstr == "mediumprchid")
    return ("hex:ba,55,d3");
  if (cstr == "mediumseagreen")
    return ("hex:3c,b3,71");
  if (cstr == "mediumslateblue")
    return ("hex:7b,68,ee");
  if (cstr == "mediumspringgreen")
    return ("hex:00,fa,9a");
  if (cstr == "mediumturquoise")
    return ("hex:48,d1,cc");
  if (cstr == "mediumvioletred")
    return ("hex:c7,15,85");
  if (cstr == "midnightblue")
    return ("hex:19,19,70");
  if (cstr == "mintcream")
    return ("hex:f5,ff,fa");
  if (cstr == "mistyrose")
  ...
  if (cstr == "orchid")
    return ("hex:da,70,d6");
  if (cstr == "oxfordindigo")
    return ("hex:41,57,98");
  if (cstr == "palegreen")
    return ("hex:98,fb,98");
  if (cstr == "paleturquoise")
    return ("hex:af,ee,ee");
  if (cstr == "palevioletred")
    return ("hex:db,70,93");
  if (cstr == "papayawhip")
    return ("hex:ff,ef,d5");
  if (cstr == "peachpuff")
    return ("hex:ff,da,b9");
  if (cstr == "pelegoldenrod")
    return ("hex:ee,e8,aa");
  if (cstr == "peru")
    return ("hex:cd,85,3f");
  if (cstr == "pink")
