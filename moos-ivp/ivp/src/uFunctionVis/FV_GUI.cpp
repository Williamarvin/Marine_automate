...
void FV_GUI::augmentMenu() {
  ...
  m_menubar->add("Color-Map/Default", 0, (Fl_Callback *)FV_GUI::cb_ColorMap,
                 (void *)1, FL_MENU_RADIO | FL_MENU_VALUE);
  m_menubar->add("Color-Map/Copper", 0, (Fl_Callback *)FV_GUI::cb_ColorMap,
                 (void *)2, FL_MENU_RADIO);
  m_menubar->add("Color-Map/Bone", 0, (Fl_Callback *)FV_GUI::cb_ColorMap,
...
void FV_GUI::addBehaviorSource(string bhv_source) {
  ...
  m_menubar->add(label.c_str(), 0, (Fl_Callback *)FV_GUI::cb_BehaviorSelect,
                 (void *)index);
}
