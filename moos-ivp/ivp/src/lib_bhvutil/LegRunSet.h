...
public: // Leg Setters
  ...
  bool addLegRun(std::string name, double leglen, double turn1_rad,
                 double turn2rad, double turn1_bias, double turn2_bias,
                 double turn1_ext, double turn2_ext, std::string turn1_dir,
