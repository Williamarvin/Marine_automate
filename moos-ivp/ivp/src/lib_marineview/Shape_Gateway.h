...
double g_gatewayBody[] = {0.0,  0.0, 3.0,  0.0,  5.0,  2.0,  5.0,
                          8.0,  3.0, 10.0, -3.0, 10.0, -5.0, 8.0,
...
double g_gatewayMidBody[] = {1.0, 3.0,  2.0, 4.0,  2.0, 6.0,  1.0, 7.0, -1.0,
                             7.0, -2.0, 6.0, -2.0, 4.0, -1.0, 3.0, 1.0, 3.0};
