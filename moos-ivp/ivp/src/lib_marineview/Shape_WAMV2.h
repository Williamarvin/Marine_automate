...
double g_wamvPontoon[] = {5.0,    100.0, 15.0, 60.0, 15.0,  -100.0, -15.0,
                          -100.0, -15.0, 60.0, -5.0, 100.0, 5.0,    100.0};

double g_wamvTopSize = 8.0;
double g_wamvTop[] = {60.0, 50.0,  70.0, 50.0, 105.0, 30.0, 105.0, -90.0,
                      15.0, -90.0, 15.0, 30.0, 50.0,  50.0, 60.0,  50.0};
