...
CPAEngine::CPAEngine() : CPAEngineRoot(0, 0, 0, 0, 0, 0) { initNonCache(); }
...
CPAEngine::CPAEngine(double cny, double cnx, double cnh, double cnv, double osy,
                     double osx)
...
void CPAEngine::reset(double cny, double cnx, double cnh, double cnv,
...
double CPAEngine::evalRangeRateOverRange(double osh, double osv,
                                         double time) const {
  return (0);
}
