...
CPAEngineThin::CPAEngineThin(double cny, double cnx, double cnh, double cnv,
...
void CPAEngineThin::reset(double cny, double cnx, double cnh, double cnv,
                          double osy, double osx) {
...
bool CPAEngineThin::crossesBowDist(double osh, double osv,
                                   double &xdist) const {
...
bool CPAEngineThin::crossesSternDist(double osh, double osv,
                                     double &xdist) const {
...
bool CPAEngineThin::passesPortDist(double osh, double osv,
                                   double &xdist) const {
...
bool CPAEngineThin::passesStarDist(double osh, double osv,
                                   double &xdist) const {
  // Until shown otherwise, xdist is -1, meaning os does not pass cn
  xdist = -1;
