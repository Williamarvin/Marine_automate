...
void XYGrid::handleSegment(double x1, double y1, double x2, double y2) {
...
bool XYGrid::segIntersectBound(double x1, double y1, double x2,
                               double y2) const {
...
bool XYGrid::initialize(XYPolygon poly, const XYSquare &unit_square,
                        double init_value) {
