...
XYArc::XYArc(double g_x, double g_y, double g_rad, double g_langle,
             double g_rangle)
...
XYArc::XYArc(double g_x, double g_y, double g_rad, double g_langle,
             double g_rangle, double g_ax1, double g_ay1, double g_ax2,
             double g_ay2)
    : XYCircle(g_x, g_y, g_rad) {
  m_langle = g_langle;
  m_rangle = g_rangle;
...
void XYArc::set(double g_x, double g_y, double g_rad, double g_langle,
                double g_rangle) {
...
bool XYArc::containsPoint(double x, double y) const {
  return (XYCircle::containsPoint(x, y) &&
          containsAngle(relAng(m_x, m_y, x, y)));
}
...
bool XYArc::segIntersectStrict(double x1, double y1, double x2,
                               double y2) const {
...
int XYArc::segIntersectPts(double x1, double y1, double x2, double y2,
                           double &rx1, double &ry1, double &rx2,
                           double &ry2) const {
