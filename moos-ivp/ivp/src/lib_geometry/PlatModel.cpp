...
void PlatModel::setCachePtCPA(bool port, unsigned int ix, XYPoint cpa_pt) {
...
void PlatModel::setCacheDistCPA(bool port, unsigned int ix, double cpa) {
  if (port && (ix < m_port_seglrs.size()))
...
void PlatModel::setCacheStemCPA(bool port, unsigned int ix, double stem_cpa) {
  if (port && (ix < m_port_seglrs.size()))
