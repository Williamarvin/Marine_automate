...
double CPAEngineV15::evalCPA(double osCRS, double osSPD, double osTOL,
                             double *calcROC) const {
...
bool CPAEngineV15::crossesBowDist(double osCRS, double osSPD,
                                  double &xdist) const {
...
bool CPAEngineV15::crossesSternDist(double osCRS, double osSPD,
                                    double &xdist) const {
  // Special case 1: ownship and contact position are the same
  if (stat_os_on_contact) {
    xdist = 0;
