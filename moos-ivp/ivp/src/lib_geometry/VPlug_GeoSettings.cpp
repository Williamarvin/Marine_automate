...
bool VPlug_GeoSettings::setParam(string param, string value) {
  ...
  if ((param == "polygon_viewable_all") ||
      ...
      (param == "seglist_viewable_labels") || (param == "seglr_viewable_all") ||
      (param == "seglr_viewable_labels") ||
      (param == "drop_point_viewable_all") ||
      (param == "marker_viewable_all") || (param == "marker_viewable_labels") ||
      (param == "grid_viewable_all") || (param == "grid_viewable_labels") ||
      (param == "circle_viewable_all") || (param == "circle_viewable_labels") ||
      (param == "point_viewable_all") || (param == "point_viewable_labels") ||
      (param == "vector_viewable_all") || (param == "vector_viewable_labels") ||
      (param == "oparea_viewable_all") || (param == "oparea_viewable_labels") ||
      (param == "datum_viewable") || (param == "hash_viewable") ||
      (param == "tiff_viewable") || (param == "range_pulse_viewable_all") ||
    ...
    return (setViewMapping(param, value));
           ...
           (param == "drop_point_vertex_color") || (param == "datum_color"))
...
bool VPlug_GeoSettings::setSizeMapping(string attr, string gsize, double min,
                                       double max) {
...
bool VPlug_GeoSettings::setColorMapping(string attr, string color_str) {
...
bool VPlug_GeoSettings::setAttrMapping(string attr, string value) {
...
bool VPlug_GeoSettings::viewable(const string &attr, bool default_value) const {
...
string VPlug_GeoSettings::strvalue(string attr) {
  ...
  if ((attr == "polygon_viewable_all") || (attr == "polygon_viewable_labels") ||
      (attr == "seglist_viewable_all") || (attr == "seglist_viewable_labels") ||
      (attr == "seglr_viewable_all") || (attr == "seglr_viewable_labels") ||
      (attr == "point_viewable_all") || (attr == "point_viewable_labels") ||
      (attr == "vector_viewable_all") || (attr == "vector_viewable_labels") ||
      (attr == "grid_viewable_all") || (attr == "grid_viewable_labels") ||
      (attr == "circle_viewable_all") || (attr == "circle_viewable_labels") ||
      (attr == "oparea_viewable_all") || (attr == "oparea_viewable_labels") ||
      (attr == "datum_viewable") || (attr == "hash_viewable") ||
      (attr == "tiff_viewable") || (attr == "drop_point_viewable_all") ||
      (attr == "marker_viewable_all") || (attr == "marker_viewable_labels") ||
  ...
  if ((attr == "datum_size") || (attr == "drop_point_vertex_size") ||
      (attr == "hash_delta"))
