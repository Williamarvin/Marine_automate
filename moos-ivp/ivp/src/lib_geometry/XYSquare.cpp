...
XYSquare::XYSquare(double xlen, double ylen) { set(0, xlen, 0, ylen); }

//-------------------------------------------------------------
// Procedure: Constructor

XYSquare::XYSquare(double xylen) { set(0, xylen, 0, xylen); }

//-------------------------------------------------------------
// Procedure: Operator==

bool XYSquare::operator==(const XYSquare &other) const {
  return ((m_xlow == other.m_xlow) && (m_xhigh == other.m_xhigh) &&
          (m_ylow == other.m_ylow) && (m_yhigh == other.m_yhigh));
}
...
double XYSquare::segIntersectLength(double x1, double y1, double x2,
                                    double y2) const {
  ...
  if ((x1 < m_xlow) && (x2 < m_xlow))
    return (0);
  if ((x1 > m_xhigh) && (x2 > m_xhigh))
    return (0);
  if ((y1 < m_ylow) && (y2 < m_ylow))
    return (0);
  if ((y1 > m_yhigh) && (y2 > m_yhigh))
    return (0);
...
double XYSquare::segDistToSquare(double x1, double y1, double x2,
                                 double y2) const {
  double dist[4];
