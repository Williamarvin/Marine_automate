...
int main(int argc, char *argv[]) {
  ...
  if (scanArgs(argc, argv, "-h", "--help", "-help")) {
    cout << "Usage: " << endl;
    cout << "  alogsort in.alog [out.alog] [OPTIONS]                    "
         << endl;
    cout << "                                                           "
         << endl;
    cout << "Synopsis:                                                  "
         << endl;
    cout << "  Create a new MOOS .alog file by sorting the alog entries "
         << endl;
    cout << "  based on their timestamps.                               "
         << endl;
    cout << "                                                           "
         << endl;
    ...
    cout << "  -f,--force    Force overwrite of existing file           "
         << endl;
    cout << "  -c,--check    Just check the ordering with no sorting    "
         << endl;
    ...
    cout << "See also:                                                  "
         << endl;
    cout << "  aloggrep, alogscan, alogrm, alogclip, alogview           "
         << endl;
    cout << endl;
    return (0);
  }
