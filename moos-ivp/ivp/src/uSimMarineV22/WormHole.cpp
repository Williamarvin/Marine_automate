...
void WormHole::crossPositionWeberToMadrid(double wx, double wy, double &mx,
                                          double &my) {
...
void WormHole::crossPositionMadridToWeber(double mx, double my, double &wx,
                                          double &wy) {
...
void WormHole::getCrossPosition(XYPolygon polya, XYPolygon polyb, double ax,
