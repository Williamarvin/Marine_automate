...
int main(int argc, char **argv) {
  string pts = "pts={107.5,-53.5:112,-43.8:112,-46.1:111.7,-49.3:108.3,-52.7:"
               "107.7,-53.3}";

  pts = "pts={108.9,-39.9:107.88,-38.88:112,-43:110.32,-41.32:109.39,-40.39:"
        "107.8,-38.8:108.02,-39.02:108.19,-39.19:110.16,-41.16:111.68,-42.68:"
        "108.9,-39.9:107.52,-38.52:108.9,-39.9:108.65,-39.65:108.61,-39.61:105."
        "96,-38:107.35,-38.35:103.81,-38:102.14,-38:109.01,-40.01}";

  pts = "pts={96.02,-42.98:96.76,-42.05:98.56,-39.8:98.72,-39.6:99.92,-38.1:"
        "100.08,-38:107,-38}";
  ...
  for (int i = 1; i < argc; i++) {
    ...
    if (strBegins(argi, "pts="))
      ...
      cout << "Example:                                         " << endl;
      cout << "$ testConvexHull "
              "pts={107.5,-53.5:112,-43.8:112,-46.1:111.7,-49.3:108.3,-52.7:"
              "107.7,-53.3}"
           << endl;
      cout << "hull=6" << endl;
      return (0);
