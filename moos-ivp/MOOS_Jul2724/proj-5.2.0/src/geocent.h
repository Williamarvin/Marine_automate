...
long pj_Convert_Geodetic_To_Geocentric(GeocentricInfo *gi, double Latitude,
...
void pj_Convert_Geocentric_To_Geodetic(GeocentricInfo *gi, double X, double Y,
                                       double Z, double *Latitude,
                                       double *Longitude, double *Height);
/*
