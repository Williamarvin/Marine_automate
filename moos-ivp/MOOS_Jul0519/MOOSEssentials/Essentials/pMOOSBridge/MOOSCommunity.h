...
#if !defined(                                                                  \
    AFX_MOOSCOMMUNITY_H__5F2162C1_2606_485D_8F10_610257FD8A67__INCLUDED_)
...
public:
  ...
  bool InitialiseMOOSClient(const std::string &sHostName, long nPort,
                            const std::string &sMOOSName, int nFreq);
