...
protected:
  ...
  // called to figure out what xterm parameters should be used with launch (ie
  // where should the xterm be and how should it look)
  bool MakeConsoleLaunchParams(std::string sParam, STRING_LIST &LaunchList,
                               std::string sProcName, std::string sMOOSName);

  // caled to figure out what if any additional  parameters should be passed to
  ...
  // this is used to communicate with the BD and ultimately other instantiations
  // of pAntler on different machines...
