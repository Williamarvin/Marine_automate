...
/*!
    ...
    @discussion  Uses the zlib library to write strings to file. Compressions is
...
public:
  /*!
   ...
   @param	sFileNameBase  the base name of the compressed file. e.g t.txt
   will become t.txt.gz
   */
  ...
  /*!
   ...
   @discussion  Stop zipping and terminate the compressed file correctly,
   blocking call
   */
  bool Stop();
  ...
  /*!
   ...
   @discussion Add a string to teh background threads work. This will eventually
   be added
