...
public:
  ...
  bool LatLong2LocalUTM(double lat, double lon, double &MetersNorth,
                        double &MetersEast);
  bool LocalGrid2LatLong(double dfEast, double dfNorth, double &dfLat,
                         double &dfLon);
...
private:
  ...
  bool LLtoUTM(int ReferenceEllipsoid, const double Lat, const double Long,
...
public:
  ...
  bool LatLong2LocalGrid(double lat, double lon, double &MetersNorth,
                         double &MetersEast);
...
static CMOOSGeodesy::CEllipsoid ellipsoid[] =
    { //  id, Ellipsoid name, Equatorial Radius, square of eccentricity
        CMOOSGeodesy::CEllipsoid(
            -1, "Placeholder", 0,
            0), // placeholder only, To allow array indices to match id numbers
        CMOOSGeodesy::CEllipsoid(1, "Airy", 6377563, 0.00667054),
        CMOOSGeodesy::CEllipsoid(2, "Australian National", 6378160,
                                 0.006694542),
        CMOOSGeodesy::CEllipsoid(3, "Bessel 1841", 6377397, 0.006674372),
        CMOOSGeodesy::CEllipsoid(4, "Bessel 1841 (Nambia) ", 6377484,
                                 0.006674372),
        ...
        CMOOSGeodesy::CEllipsoid(8, "Fischer 1960 (Mercury) ", 6378166,
                                 0.006693422),
        ...
        CMOOSGeodesy::CEllipsoid(18, "Modified Fischer 1960", 6378155,
                                 0.006693422),
        CMOOSGeodesy::CEllipsoid(19, "South American 1969", 6378160,
                                 0.006694542),
