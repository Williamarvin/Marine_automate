...
/** This class is part of MOOS's internal transport mechanism. It any number of
CMOOSMsg's can be packed into a CMOOSCommPkt and sent in one lump between a
CMOOSCommServer and CMOOSCommClient object. It is never used by a user of
MOOSLib */
class CMOOSCommPkt {
public:
  CMOOSCommPkt();
   ...
   */
  bool Serialize(MOOSMSG_LIST &List, bool bToStream = true,
...
protected:
  ...
  // how many messages are contained in this  packet when serialsised to a
  // stream?
