...
public:
  struct tSkewInfo {
    tSkewInfo()
        : m(0), c(0), LB(0), UB(0), envLB(0), envUB(0), envEst(0), filtEst(0) {}
    double m, c;
...
public:
  ...
  virtual double Update(double dfRQtime, double dfTXtime, double dfRXtime,
                        tSkewInfo *skewinfo = NULL);
...
private:
  ...
  double SmoothingFilter(double dfDT, double dfOldFilterVal, double dfNewMeas,
...
public:
  ...
  double Update(double dfRQtime, double dfTXtime, double dfRXtime,
                tSkewInfo *skewinfo) {
    ...
    double dfSkew =
        CMOOSSkewFilter::Update(dfRQtime, dfTXtime, dfRXtime, skewinfo);
...
private:
  CMOOSConditionedSkewFilter(
      const CMOOSConditionedSkewFilter &v);            // Not implemented
