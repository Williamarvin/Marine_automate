...
public:
  // Overladed = operator used to store the value in its original and endian
  // format
  ...
  // Sets the Value of the endian object and stores the value in its original
  // and endia format
  ...
  OrigType getEndianValue() { return EndianVal.EndianValue; }

  // Return the original value
  OrigType getOriginalValue() { return OriginalVal; }
};
