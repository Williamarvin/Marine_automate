...
bool XPCUdpSocket::GetAddress(long int nPort, const std::string &sHost,
                              sockaddr_in &Address) {
...
int XPCUdpSocket::iBroadCastMessage(void *_vMessage, int _iMessageSize,
                                    long int nPort) {
...
int XPCUdpSocket::iSendMessageTo(void *_vMessage, int _iMessageSize,
                                 long int nPort, const std::string &sHost) {
...
int XPCUdpSocket::iRecieveMessage(void *_vMessage, int _iMessageSize,
                                  int _iOption) {
  ...
  iNumBytes = recvfrom(iSocket, (char *)_vMessage, _iMessageSize, _iOption,
...
int XPCUdpSocket::iReadMessageWithTimeOut(void *_vMessage, int _iMessageSize,
