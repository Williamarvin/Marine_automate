...
CMOOSVariable::CMOOSVariable(std::string sName, std::string sSubscribe,
                             std::string sPublish, double dfCommsTime) {
  m_bDouble = false; // true;
  m_bFresh = false;
  m_sName = sName;
...
std::string CMOOSVariable::GetSubscribeName() const { return m_sSubscribeName; }

bool CMOOSVariable::IsFresh() const { return m_bFresh; }

std::string CMOOSVariable::GetName() const { return m_sName; }

std::string CMOOSVariable::GetPublishName() const { return m_sPublishName; }

bool CMOOSVariable::IsDouble() const { return m_bDouble; }

double CMOOSVariable::GetDoubleVal() const { return m_dfVal; }

double CMOOSVariable::GetTime() const { return m_dfTimeWritten; }

std::string CMOOSVariable::GetStringVal() const { return m_sVal; }
...
std::string CMOOSVariable::GetWriter() const { return m_sSrc; }
