...
/** @brief Class that derives from CMOOSApp and adds functionality of cross
...
protected:
  ...
  /** called from OnStartUp - overload to execute custom start up code for
   * sensor*/
  ...
  /** set to true if this instrument should publish the raw incoming data to the
   * DB*/
  bool m_bPublishRaw;
