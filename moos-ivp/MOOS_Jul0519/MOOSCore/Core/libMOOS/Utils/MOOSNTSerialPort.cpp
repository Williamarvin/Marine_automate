...
bool CMOOSNTSerialPort::Create(const char *pPortNum, int nBaudRate) {
  ...
  if (!m_bUseCsmExt) {
    ...
    switch (nBaudRate) {
    case 500000:
      eBaud = CNTSerial::EBaud500000;
      break;
    case 256000:
      eBaud = CNTSerial::EBaud256000;
      break;
    case 128000:
      eBaud = CNTSerial::EBaud128000;
      break;
    case 115200:
      eBaud = CNTSerial::EBaud115200;
      break;
    case 57600:
      eBaud = CNTSerial::EBaud57600;
      break;
    case 38400:
      eBaud = CNTSerial::EBaud38400;
      break;
    case 19200:
      eBaud = CNTSerial::EBaud19200;
      break;
    case 9600:
      eBaud = CNTSerial::EBaud9600;
      break;
    case 4800:
      eBaud = CNTSerial::EBaud4800;
      break;
    case 2400:
      eBaud = CNTSerial::EBaud2400;
      break;
    case 1200:
      eBaud = CNTSerial::EBaud1200;
      break;
    case 600:
      eBaud = CNTSerial::EBaud600;
      break;
    case 300:
      eBaud = CNTSerial::EBaud300;
      break;
    ...
    switch (nBaudRate) {
    case 500000:
      eBaud = CNTSerial::EBaudCSM500000;
      break;
    case 38400:
      eBaud = CNTSerial::EBaudCSM38400;
      break;
    case 19200:
      eBaud = CNTSerial::EBaudCSM19200;
      break;
    case 9600:
      eBaud = CNTSerial::EBaudCSM9600;
      break;
  ...
  lLastError = CNTSerial::Setup(eBaud, CNTSerial::EData8, CNTSerial::EParNone,
                                CNTSerial::EStop1);
  ...
  CNTSerial::EHandshake eHS =
      m_bHandShaking ? CNTSerial::EHandshakeHardware : CNTSerial::EHandshakeOff;
