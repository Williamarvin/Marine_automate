...
/** constructor. */
CMOOSLinuxSerialPort::CMOOSLinuxSerialPort() { m_nPortFD = -1; }

/** Destructor.Reset the port option to what every they were before and close
port*/
CMOOSLinuxSerialPort::~CMOOSLinuxSerialPort() { Close(); }
...
#ifdef B500000
  case 500000:
    nLinuxBaudRate = B500000;
    break;
#endif
  case 115200:
    nLinuxBaudRate = B115200;
    break;
  case 57600:
    nLinuxBaudRate = B57600;
    break;
  case 38400:
    nLinuxBaudRate = B38400;
    break;
  case 19200:
    nLinuxBaudRate = B19200;
    break;
  case 9600:
    nLinuxBaudRate = B9600;
    break;
  case 4800:
    nLinuxBaudRate = B4800;
    break;
  case 2400:
    nLinuxBaudRate = B2400;
    break;
  case 1200:
    nLinuxBaudRate = B1200;
    break;
  case 600:
    nLinuxBaudRate = B600;
    break;
...
int CMOOSLinuxSerialPort::GetFD() { return m_nPortFD; }
...
#ifndef _WIN32
  tcsetattr(m_nPortFD, TCSANOW, &m_OldPortOptions);
