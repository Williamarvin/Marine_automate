...
void PrintHelpAndExit() {
  MOOSTrace("\n\nThis test tests the behaviour and response of a DB/App pair "
            "when the application\n"
            "publishes in every iteration the variable it is subscribing to. "
            "Behaviour in this case\n"
            "is governed (when using Asynchronous comms clients) by the "
            "MaximumAppTick parameter. \n");
...
public:
  void OnPrintHelpAndExit() { PrintHelpAndExit(); }
