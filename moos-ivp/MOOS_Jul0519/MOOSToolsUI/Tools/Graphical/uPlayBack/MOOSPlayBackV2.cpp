...
bool CMOOSPlayBackV2::IsOpen() { return m_ALog.IsOpen(); }

int CMOOSPlayBackV2::GetSize() { return m_ALog.GetLineCount(); }

double CMOOSPlayBackV2::GetTimeNow() {
  return m_dfLastMessageTime - m_dfLogStart;
}

int CMOOSPlayBackV2::GetCurrentLine() { return m_nLastLine; }
...
double CMOOSPlayBackV2::GetLastMessageTime() { return m_dfLastMessageTime; }
