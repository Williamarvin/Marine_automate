...
ALogIndexWrapper::ALogIndexWrapper()
    : m_bInitialized(false), m_nLineCount(-1) {}

////////////////////////////////////////////////////////////////////////////////
ALogIndexWrapper::~ALogIndexWrapper() { Close(); }

////////////////////////////////////////////////////////////////////////////////
bool ALogIndexWrapper::Open(const std::string &sfName) {
  if (m_ALog.Init(sfName) == false) {
    // printf("Initialisation of indexedAlogReader failed. Ensure that the alog
    // path is correct:\n \t'%s'\n\n and that the corresponding index file
...
std::string ALogIndexWrapper::GetFileName() { return m_sFileName; }

////////////////////////////////////////////////////////////////////////////////
bool ALogIndexWrapper::IsOpen() { return m_bInitialized; }
...
////////////////////////////////////////////////////////////////////////////////
bool ALogIndexWrapper::GetNextToken(const std::string &s, int &nPos,
                                    std::string &sTk) {
...
////////////////////////////////////////////////////////////////////////////////
int ALogIndexWrapper::GetLineCount() { return m_nLineCount; }
...
////////////////////////////////////////////////////////////////////////////////
double ALogIndexWrapper::GetStartTime() { return m_ALog.GetStartTime(); }
