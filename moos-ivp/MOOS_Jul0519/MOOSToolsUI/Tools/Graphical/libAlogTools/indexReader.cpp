...
indexReader::indexReader()
    : m_alogHeader(), m_alogMsgList(), m_alogSrcList(), m_alogRecords() {}
...
void indexReader::GetMsgTypes(vector<string> &msgTypes) {
  ...
  std::copy(m_alogMsgList.begin(), m_alogMsgList.end(),
            inserter(msgTypes, msgTypes.begin()));
}
...
////////////////////////////////////////////////////////////////////////////////
double indexReader::GetStartTime() const { return m_alogHeader.startTime; }

////////////////////////////////////////////////////////////////////////////////
int indexReader::GetNumRecords() const { return m_alogRecords.size(); }
