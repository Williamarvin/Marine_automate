...
//---------------------------------------------------------
// Procedure: setX()
void VisitPoint::setX(double v) { m_x = v; }
//---------------------------------------------------------
// Procedure: setY()
void VisitPoint::setY(double v) { m_y = v; }
//---------------------------------------------------------
// Procedure: setState()
...
//---------------------------------------------------------
// Procedure: setID()
void VisitPoint::setID(std::string id) { m_id = id; }
//---------------------------------------------------------
// Procedure: setVehicle()
void VisitPoint::setVehicle(std::string s) { m_vehicle = tolower(s); }
//---------------------------------------------------------
// Procedure: getX()
double VisitPoint::getX() { return (m_x); }
//---------------------------------------------------------
// Procedure: getY()
double VisitPoint::getY() { return (m_y); }
//---------------------------------------------------------
// Procedure: getState()
string VisitPoint::getState() { return (m_state); }
//---------------------------------------------------------
// Procedure: getID()
string VisitPoint::getID() { return (m_id); }
//---------------------------------------------------------
// Procedure: getVehicle()
string VisitPoint::getVehicle() { return (m_vehicle); }
//---------------------------------------------------------
// Procedure: getSpec()
