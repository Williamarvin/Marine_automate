...
public:
  ...
  bool setResistanceWeight(double val) {
    m_resistance_weight = val;
    return (true);
  };

  bool setSocialMode(std::string val);

  bool setIntraAgentSameOptionCoupling(double val) {
    m_alpha = val;
    return (true);
  };
  bool setIntraAgentInterOptionCoupling(std::string); // beta
  bool setInterAgentSameOptionCoupling(double val) {
    m_gamma = val;
    return (true);
  };
  bool setInterAgentInterOptionCoupling(std::string); // delta

  bool setInputVar(std::string val) {
    m_input_var = toupper(val);
    return (true);
  };
  bool setInputFunType(std::string val);
  bool setMaxInputVal(double val) {
    m_max_input_val = val;
    return (true);
  };
  bool setMinInputVal(double val) {
    m_min_input_val = val;
    return (true);
  };
  bool setInputGain(double val) {
    m_input_gain = val;
    return (true);
  };
  ...
  unsigned int getOptionOutputs(std::vector<std::string> &names,
  ...
  unsigned int numberOfConditions() {
    return (m_active_condition_name.size());
  };
...
Option buildOptionFromSpec(std::list<std::string> spec, bool &ok,
                           std::string &warn_msg);
