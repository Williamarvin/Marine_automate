...
bool SockNinjaProtoBuf::setupConnection() { return (true); }
...
bool SockNinjaProtoBuf::readFromSock() { return (true); }
...
bool SockNinjaProtoBuf::sendSockMessageString(string str) { return (true); }
...
bool SockNinjaProtoBuf::sendSockMessageDouble(double val) { return (true); }
