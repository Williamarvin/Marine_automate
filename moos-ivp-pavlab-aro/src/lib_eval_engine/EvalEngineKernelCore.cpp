...
bool EvalEngineKernel::updateSubscriptions(std::string old_val,
                                           std::string new_val) {
...
bool EvalEngineKernel::updatePublications(std::string old_val,
                                          std::string new_val) {
...
/*
    These following functions are defined by the user and the kernel which
   inherits from this base class

    > virtual bool EvalEngineKernel::SetParams(const std::map<std::string,
   std::string> &params){};

    > virtual bool EvalEngineKernel::UpdateVariable(const EEMessage &message){};

    > virtual bool EvalEngineKernel::Evaluate(std::map<std::string, std::string>
   &updates){};
