...
EEMessage::EEMessage(std::string varname, std::string message,
                     double time_stamp) {
  name = varname;
...
std::string EEMessage::getVarName() const { return name; }

std::string EEMessage::msg() const { return contents_str; }

double EEMessage::time_stamp() const { return timestamp; }