...
public:
  ...
  // Setup functions:
  bool setTauU(double val) {
    m_tau_u = val;
    return (true);
  };
  bool setUth(double val) {
    m_u_th = val;
    return (true);
  };
  bool setSatFunOrder(double val) {
    m_Hill_order = val;
    return (true);
  };
  bool setMinAtten(double val) {
    m_u_min = val;
    return (true);
  };
  bool setMaxAtten(double val) {
    m_u_max = val;
    return (true);
  };
  ...
  bool setGroup(std::string val) {
    m_group = val;
    return (true);
  };
  bool setStaleThresh(double val) {
    m_stale_thresh = val;
    return (true);
  };
  bool setSocialTick(double val) {
    if (val > 0) {
      m_social_tick = val;
      return (true);
    } else {
  ...
  bool setOpinionThresh(double val) {
    m_opinion_thresh = val;
    return (true);
  };
  ...
  bool getUpdatedOptionStateLists(std::vector<std::string> &opt_names,
  ...
  bool loadValIntoBuffer(std::string var, std::string val) {
    return (m_info_buff.setValue(var, val));
  };
  bool loadValIntoBuffer(std::string var, double val) {
    return (m_info_buff.setValue(var, val));
  };
  ...
  bool getOutputsForLargestOpinion(std::vector<std::string> &names,
...
private:
  ...
  double satFunctionHill(double y) {
    return (pow(y, m_Hill_order) /
