...
bool HeronSim::DealWithNMEA(string nmea) {
  ...
  reportRunWarning("Received input from socket that cannot be processed: " +
                   nmea);
...
// note:
// $CPNVR,time,vel_east,vel_north,vel_down,rate_pitch,rate_roll,rate_yaw*CS
...
bool HeronSim::PublishCPNVR() {
  ...
  string msg = "CPNVR," + utc + "," + str_vel_east + "," + str_vel_north + "," +
               vel_down;
