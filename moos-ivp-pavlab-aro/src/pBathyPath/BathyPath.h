...
protected:
  ...
  bool getNextCellLookahead(double curr_x, double curr_y, double curr_heading,
                            double &new_x, double &new_y, int &new_id);
  bool buildPathTree(int iterations, double curr_x, double curr_y,
...
private: // State variables
  ...
  double m_prob_scale_factor =
      10000; // needed because Fast GPR skews the variance
