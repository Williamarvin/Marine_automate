...
BHV_AndersonTurn::BHV_AndersonTurn(IvPDomain gdomain) : IvPBehavior(gdomain) {
...
void BHV_AndersonTurn::onIdleToRunState() { resetStateVars(); }

//-----------------------------------------------------------
// Procedure: onRunToIdleState()

void BHV_AndersonTurn::onRunToIdleState() { handleComplete(); }
