...
BHV_PModelView::BHV_PModelView(IvPDomain gdomain) : IvPBehavior(gdomain) {
...
void BHV_PModelView::onRunToIdleState() { eraseTurnPath(); }
...
IvPFunction *BHV_PModelView::buildOF() { return (0); }
