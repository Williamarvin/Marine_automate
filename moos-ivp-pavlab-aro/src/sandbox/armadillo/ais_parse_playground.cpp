...
int sgn(long int val) { return (0 < val) - (val < 0); }
...
int main() {
  ...
  // string ascii =
  // "55NdvIT0Bk4iL@WSC;9A8t<60tpF00000000000U2h;26t0Ht4kQEl3lU84R@0000000000";
  ...
  string payload =
      "000101000101011110101100111110011001100100000000010010110011000100110001"
      "011100010000100111100011010011001011001001010001001000111100001100000110"
      "000000111100111000010110000000000000000000000000000000000000000000000000"
      "000000000000000000100101000010110000001011000010000110111100000000011000"
      "111100000100110011100001010101110100000011110100100101001000000100100010"
  ...
  long int yy =
      sgn(pow(2, N - 1) - val) * (pow(2, N - 1) - abs(pow(2, N - 1) - val));
  if ((yy == 0) && (val != 0))
    cout << -val << endl;
  else
    cout << yy << endl;
