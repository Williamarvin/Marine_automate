...
bool VehRotController::handlePoint(std::string sval) {
  ...
  double calc_heading =
      atan2((dlb_x - m_nav_x_start_rot), (dlb_y - m_nav_y_start_rot));
...
bool VehRotController::checkClearToRotate(double nav_x, double nav_y,
                                          double curr_time) {
...
bool VehRotController::calControl(double nav_heading, double nav_x,
                                  double nav_y, double &thrust,
                                  double &rudder) {
...
int VehRotController::calcHeadingDiff(double curr_heading,
                                      double target_heading) {

  int curr_heading_int = (int)round(curr_heading);
  int target_heading_int = (int)round(target_heading);
  int heading_diff =
      (((curr_heading_int - target_heading_int) + 540) % 360) - 180;
