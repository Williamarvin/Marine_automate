...
public:
  ...
  // SET functions
  bool setRotateInPlace(bool val) {
    m_rotate_in_place = val;
    return (true);
  }
  bool setHeadingTarget(double val) {
    m_heading_target = val;
    return (true);
  }
  bool setCmdTimeStamp(double val) {
    m_cmd_tstamp = val;
    return (true);
  }
  bool setStartRotX(double val) {
    m_nav_x_start_rot = val;
    return (true);
  }
  bool setStartRotY(double val) {
    m_nav_y_start_rot = val;
    return (true);
  }
  bool setRotateRadius(double val) {
    m_rotate_radius = val;
    return (true);
  }
  bool setMaxTimeLag(double val) {
    m_max_time_lag = val;
    return (true);
  }
  bool setDeadZone(double val) {
    m_dead_zone = val;
    return (true);
  }
  ...
  bool calControl(double nav_heading, double nav_x, double nav_y,
