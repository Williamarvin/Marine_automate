...
*/
float CMaths::Fraction(float value) { return value - (float)((int32)value); }

/*!-----------------------------------------------------------------------------
Function that returns the fractional part of a floating point number
*/
double CMaths::Fraction(double value) { return value - (double)((int32)value); }
...
and the maximum value. Useful for ensuring bearings lie in the range of 0 to 360
degrees etc.
...
/*!-----------------------------------------------------------------------------
Function that limits the specified value to an acceptable range of values
between a minimum and maxiumum.
...
/*!-----------------------------------------------------------------------------
Function that checks the specified values lies within the specified range limits
inclusive
...
*/
int32 CMaths::Round(float value) { return (int32)(value + 0.5F); }

/*!-----------------------------------------------------------------------------
Function that rounds a value to the nearest integer
*/
int32 CMaths::Round(double value) { return (int32)(value + 0.5); }
/*!-----------------------------------------------------------------------------
Function that rounds a value upwards to the nearest value of the specified
mutliple. i.e. Rounding 13 up to a multiple of 4 will yeild a result of 16,
while rounding 12 up will yield a value of 12.
*/
...
*/
inline float CMaths::Sign(float value) { return (value < 0.0F) ? -1.0F : 1.0F; }
...
@result +1 or -1 depending on the sign on the input value
*/
inline double CMaths::Sign(double value) { return (value < 0.0) ? -1.0 : 1.0; }
