...
*/
bool CSerialize::WriteBool(bool value) { return this->Write(value); }

/*!-----------------------------------------------------------------------------
As the specialisation of the Read<bool> template must be defined first,
Implement the function body for using it here after the definition.
*/
bool CSerialize::ReadBool(bool *value) { return this->Read(value); }
...
bool CSerialize::ReadBool(pbool value, bool defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadDouble(pdouble value) { return this->Read(value); }
bool CSerialize::ReadDouble(pdouble value, double defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadFloat(pfloat value) { return this->Read(value); }
bool CSerialize::ReadFloat(pfloat value, float defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadInt8(pint8 value) { return this->Read(value); }
bool CSerialize::ReadInt8(pint8 value, int8 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadInt16(pint16 value) { return this->Read(value); }
bool CSerialize::ReadInt16(pint16 value, int16 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadInt32(pint32 value) { return this->Read(value); }
bool CSerialize::ReadInt32(pint32 value, int32 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadInt64(pint64 value) { return this->Read(value); }
bool CSerialize::ReadInt64(pint64 value, int64 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadUint8(puint8 value) { return this->Read(value); }
bool CSerialize::ReadUint8(puint8 value, uint8 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadUint16(puint16 value) { return this->Read(value); }
bool CSerialize::ReadUint16(puint16 value, uint16 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadUint32(puint32 value) { return this->Read(value); }
bool CSerialize::ReadUint32(puint32 value, uint32 defValue) {
  return this->Read(value, defValue);
}
bool CSerialize::ReadUint64(puint64 value) { return this->Read(value); }
bool CSerialize::ReadUint64(puint64 value, uint64 defValue) {
  return this->Read(value, defValue);
}
...
@param maxChars specifies the maximum number of characters (excluding the Null
Terminator) that can be written. A value of zero allows any length
*/
...
/*!-----------------------------------------------------------------------------
@param maxChars specifies the maximum number of characters (excluding the Null
Terminator) that can be read into the buffer. A value of zero allows any length
*/
