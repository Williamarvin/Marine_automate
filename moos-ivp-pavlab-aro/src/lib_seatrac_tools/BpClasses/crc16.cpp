...
@param[in]	buf		Pointer to the buffer containing the data to
analyse.
@param[in]	offset	The offset from the begining of the buffer to start
checksumming data at.
@param[in]	length	The number of bytes to run through the checksum.
@param[in]	init	The inital value to start computing the CRC from (this
may be a previous CRC operation)
