...
/*!-----------------------------------------------------------------------------
 */
uint8 &CSerializeBuffer::operator[](uint16 idx) { return _buf[idx]; }
...
/*!-----------------------------------------------------------------------------
 */
puint8 CSerializeBuffer::GetBufPtr() { return _buf; }

/*!-----------------------------------------------------------------------------
 */
uint16 CSerializeBuffer::GetFree() { return _bufSize - _bufLen; }

/*!-----------------------------------------------------------------------------
 */
uint16 CSerializeBuffer::GetLength() const { return _bufLen; }

/*!-----------------------------------------------------------------------------
 */
uint16 CSerializeBuffer::GetReadIdx() const { return _bufRdIdx; }
...
/*!-----------------------------------------------------------------------------
 */
uint8 &CSerializeBuffer::GetUint8(uint16 idx) { return _buf[idx]; }
...
@result True if the array was added, false if the array could no be added as
there is insufficiant room on the buffer
*/
