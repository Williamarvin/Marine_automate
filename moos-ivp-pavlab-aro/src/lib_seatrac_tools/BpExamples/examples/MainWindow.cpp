...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(ui->connect, &QPushButton::clicked, &App,
          &Application::connectToSeaTrac);
  connect(ui->ping, &QPushButton::clicked, this, &MainWindow::sendPing);

  // Connect to the ping response signal
  connect(&App, &Application::pingResponse, this,
          &MainWindow::handlePingResponse);
}
...
void MainWindow::sendPing() {
  ...
  QString status = QString::fromLatin1("Pinging %1...").arg(id);
