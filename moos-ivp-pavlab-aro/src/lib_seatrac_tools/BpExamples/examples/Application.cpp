...
bool Application::connectToSeaTrac() {
  ...
  seatrac->OnCmdEncode.AttachMethod(this, &Application::writeSeaTracPort,
                                    nullptr);
  seatrac->OnCmdDecodeMsg.AttachMethod(this, &Application::messageDecoded,
                                       nullptr);
  seatrac->OnCmdDecodeLine.AttachMethod(this, &Application::lineDecoded,
                                        nullptr);

  // SYS messages
  seatrac->OnSysAlive.AttachMethod(this, &Application::seatracSysAlive,
                                   nullptr);
  ...
  seatrac->OnPingResponse.AttachMethod(this, &Application::seatracPingResponse,
                                       nullptr);
...
void Application::disconnectFromSeaTrac() {
  ...
  disconnect(port, &QSerialPort::readyRead, this,
             &Application::readSeaTracPort);
...
void Application::writeSeaTracPort(pointer context,
...
void Application::messageDecoded(pointer context,
...
void Application::lineDecoded(pointer context,
...
void Application::seatracSysAlive(pointer context,
                                  PSeatracSysAliveParams params) {
  Q_UNUSED(context)
  Q_UNUSED(params)
}

void Application::seatracSysInfo(pointer context,
                                 PSeatracSysInfoParams params) {
  Q_UNUSED(context)

  QString hardware = QString::fromLatin1("%1").arg(
      QString::number(params->Hardware.SerialNumber));
...
void Application::seatracPingResponse(pointer context,
