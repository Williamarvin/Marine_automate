...
/*!-----------------------------------------------------------------------------
 */
double CTicks::GetMicroseconds() { return CTicks::GetSeconds() * 1000000.0; }

/*!-----------------------------------------------------------------------------
 */
double CTicks::GetMilliseconds() { return CTicks::GetSeconds() * 1000.0; }

/*!-----------------------------------------------------------------------------
 */
int64 CTicks::GetNanoseconds() { return CTicks::GetNanoseconds(); }
...
/*!-----------------------------------------------------------------------------
Function that returns the frequency that the system tick counter value is
incrimented at, in counts per second.
*/
uint32 CTicks::GetTickFrequency() { return 1000000000LL; }
